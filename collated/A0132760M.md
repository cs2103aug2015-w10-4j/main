...
```
###### Tasky/src/logic/TestLogicAdd.java
``` java
    /*
     * Helper functions
     */
...
```
###### Tasky/src/logic/TestLogicDelete.java
``` java
    @Before
    public void setup(){
...
```
###### Tasky/src/logic/TestLogicEdit.java
``` java
...
```
###### Tasky/src/logic/TestLogicExecute.java
``` java
    Logic logicObject;
    File saveFile;
...
```
###### Tasky/src/logic/TestLogicHelpers.java
``` java
    @Before
    public void setup(){
        File saveFile = new File("save.txt");
...
```
###### Tasky/src/logic/TestLogicMark.java
``` java
    @Before
    public void setup(){
        File saveFile = new File("save.txt");
