...
```
###### src\storage\ManualFormatStorage.java
``` java
    @Override
...
```
###### src\storage\TestJsonFormatStorage.java
``` java
    @Before
    public void setup(){
        try {
...
```
###### src\storage\TestManualFormatStorage.java
``` java
    @Before
    public void setup(){
        try {
